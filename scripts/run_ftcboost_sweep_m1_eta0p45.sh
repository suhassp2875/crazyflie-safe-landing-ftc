...
BOOSTS=(0 5000 8000 10000 12000 14000 16000 18000 20000)
...
run_one_trial() {
    ...
    cd "$CF_FW_DIR" || exit 1
    bash "$SIM_LAUNCH" -m crazyflie -x 0 -y 0 > "$PROJECT_DIR/logs/sim_ftcboost_m${MOTOR}_eta0p45_b${boost}.log" 2>&1 &
    sleep 8
...
echo "[DONE] FTC boost m1 eta=0.45 sweep completed."
