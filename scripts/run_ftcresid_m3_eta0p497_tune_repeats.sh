...
# name r1 r2 r3 r4
# motor 3 is faulted, so r3 = 0.
# motor 1 is opposite, so r1 is dominant.
PATTERNS=(
  "r1only_9000 9000 0 0 0"
  "r1only_10000 10000 0 0 0"
  "r1only_11000 11000 0 0 0"
  "r1only_12000 12000 0 0 0"

  "r1dom_2000_9000_2000 9000 2000 0 2000"
  "r1dom_3000_10000_3000 10000 3000 0 3000"
  "r1dom_4000_11000_4000 11000 4000 0 4000"
  "r1dom_5000_12000_5000 12000 5000 0 5000"
)
...
run_one_trial() {
    ...
    echo "============================================================"
    echo "[M3 ETA0.497 TUNE] pattern=${name}, rep=${rep}, r=[$r1,$r2,$r3,$r4]"
    echo "============================================================"

    cleanup_sim

    cd "$CF_FW_DIR" || exit 1
    bash "$SIM_LAUNCH" -m crazyflie -x 0 -y 0 > "$PROJECT_DIR/logs/sim_m3_eta${eta_tag}_${name}_rep${rep}.log" 2>&1 &
    sleep 8
    ...
    local dst="$PROJECT_DIR/logs/motorloss_ftcboost_m${MOTOR}_eta${eta_tag}_b${BOOST}_r${r1}_${r2}_${r3}_${r4}_${name}_rep${rep}.csv"
...
echo "[DONE] Motor 3 eta=0.497 residual tuning repeats completed."
